...
class Day05 extends Base2019 {
  @Override
  protected Object part1(Loader loader) throws InterruptedException {
    return runWithInput(loader, 1);
  }

  @Override
  protected Object part2(Loader loader) throws InterruptedException {
    return runWithInput(loader, 5);
  }

  private long runWithInput(Loader loader, long input) throws InterruptedException {
